...
REPORT = ROOT / "v2_company_split_a10_execution_preflight_v4.txt"
PLAN = ROOT / "v2_company_split_local_execution_plan_v4.json"
...
def main() -> int:
    lines = [
        "=" * 120,
        "PRIMEYACC — COMPANY SPLIT A10 V4 MUTATION PREFLIGHT & EXACT EXECUTION PLAN",
        "=" * 120,
        f"ROOT={ROOT}",
    ...
    try:
        ...
        print("===== PRIMEYACC COMPANY SPLIT A10 V4 =====")
        ...
        print("===== PRIMEYACC COMPANY SPLIT A10 V4 =====", flush=True)
