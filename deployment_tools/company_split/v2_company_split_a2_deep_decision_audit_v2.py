...
ROOT = Path.cwd()
REPORT = ROOT / "v2_company_split_a2_deep_decision_audit_v2.txt"
...
def main() -> int:
    lines: list[str] = [
        "=" * 120,
        "PRIMEYACC — COMPANY SPLIT A2 V2 DEEP READ-ONLY DECISION AUDIT",
        "=" * 120,
    ...
    try:
        ...
        print("===== PRIMEYACC COMPANY SPLIT A2 V2 DEEP READ-ONLY DECISION AUDIT =====")
