...
R=Path.cwd();OUT=R/"v2_26_b2c_company11_pilot_discovery_v2.txt"
...
print("===== PRIMEYACC V2-26 B2C COMPANY 11 PILOT V2 =====",flush=True)
...
bs=list(Branch.objects.filter(company=c).values('id','branch_code','name','is_default','email','phone','mobile','city','district','region','address','building_number','street_name','postal_code','short_address'))
...
OUT.write_text("===== PRIMEYACC V2-26 B2C COMPANY 11 PILOT DISCOVERY V2 =====\n"+data+"\nMUTATION_PERFORMED=NO\nRESULT=PASS\n",encoding="utf8")
