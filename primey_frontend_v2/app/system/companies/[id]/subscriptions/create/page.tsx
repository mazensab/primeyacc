...
const translations = {
  ar: {
    ...
    totalHint: "\u0633\u064a\u062a\u0645 \u0627\u062d\u062a\u0633\u0627\u0628 \u0627\u0644\u0633\u0639\u0631 \u0648\u0627\u0644\u0636\u0631\u064a\u0628\u0629 \u0648\u0627\u0644\u0625\u062c\u0645\u0627\u0644\u064a \u062a\u0644\u0642\u0627\u0626\u064a\u064b\u0627 \u0639\u0646\u062f \u0625\u0646\u0634\u0627\u0621 \u0627\u0644\u0627\u0634\u062a\u0631\u0627\u0643.",
    ...
    pending: "\u0633\u064a\u062a\u0645 \u0625\u0646\u0634\u0627\u0621 \u0627\u0644\u0627\u0634\u062a\u0631\u0627\u0643 \u0628\u062d\u0627\u0644\u0629 \u0627\u0646\u062a\u0638\u0627\u0631 \u0627\u0644\u062f\u0641\u0639.",
  },
  en: {
    ...
    totalHint: "Price, VAT, and the final total are calculated automatically when the subscription is created.",
    ...
    pending: "The subscription will be created in pending payment status.",
  },
} as const;
      ...
      <div className="w-full space-y-4 lg:space-y-6">
        <header className="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
          ...
          <div className="flex shrink-0 flex-wrap items-center gap-2">
            ...
            <Button
              type="submit"
              form="company-subscription-create-form"
          ...
          <CardHeader>
            ...
            <CardDescription>
              {loading && !company
                ? t.companyLoading
                : locale === "ar"
                  ? `معرف الشركة #${company?.id || companyId}`
                  : `Company ID #${company?.id || companyId}`}
            </CardDescription>
          </CardHeader>
          <CardContent>
            {loading && !company ? (
              <p className="text-sm text-muted-foreground">{t.companyLoading}</p>
            ) : (
        ...
        <form
          id="company-subscription-create-form"
          onSubmit={handleSubmit}
          className="space-y-4 lg:space-y-6"
        >
          <Card>
            <CardHeader>
              <CardTitle icon={CreditCard} iconPosition="opposite">
                {t.subscriptionData}
              </CardTitle>
            ...
            <CardContent className="grid gap-5 md:grid-cols-2 xl:grid-cols-4">
              <div className="md:col-span-2 xl:col-span-2">
                <div className="mb-2 text-sm font-medium">{t.plan}</div>
                <Select
                  value={form.planId}
                ...
                >
                  <SelectTrigger className="h-11 rounded-lg bg-background">
                    <SelectValue
                      placeholder={loading ? t.loadingPlans : t.choosePlan}
                    />
                  </SelectTrigger>
                  <SelectContent>
                    {plans.map((plan) => (
                ...
                {!loading && plans.length === 0 ? (
                  <p className="mt-2 text-xs text-destructive">{t.noPlans}</p>
                ) : null}
              </div>

              <div>
                <div className="mb-2 text-sm font-medium">{t.billingCycle}</div>
                <Select
              ...
              <div>
                <div className="mb-2 text-sm font-medium">{t.startDate}</div>
                <Popover>
                  <PopoverTrigger asChild>
                    <Button
                      type="button"
                      variant="outline"
                      className="h-11 w-full justify-start rounded-lg bg-background font-normal"
                    >
              ...
              <div>
                <div className="mb-2 text-sm font-medium">{t.discountAmount}</div>
                <Input
                  type="number"
                  step="0.01"
                  min="0"
              ...
              <div>
                <div className="mb-2 text-sm font-medium">{t.vatRate}</div>
                <Input
                  type="number"
                  step="0.01"
                  min="0"
              ...
              <div className="md:col-span-2 xl:col-span-2">
                <label className="flex h-11 items-center gap-3 rounded-lg border bg-background px-3 text-sm font-medium">
                  <input
                    type="checkbox"
          ...
          <Card>
            <CardHeader>
              <CardTitle icon={ReceiptText} iconPosition="opposite">
                {t.billingData}
              </CardTitle>
            ...
            <CardContent className="space-y-5">
              <div className="grid gap-5 lg:grid-cols-[280px_minmax(0,1fr)]">
                <div className="rounded-lg border bg-muted/20 p-4">
                  ...
                  <p className="mt-2 inline-flex items-center gap-1 text-2xl font-bold tabular-nums">
                    <Image
                ...
                <div className="grid gap-5 md:grid-cols-2">
                  <div>
                    ...
                    <Input
                      ...
                      onChange={(event) =>
                        updateField("billingReference", event.target.value)
                      }
                      className="h-11 rounded-lg"
                    />
                  </div>
                  ...
                  <div className="md:col-span-2">
                    ...
                    <textarea
                      ...
                      className="min-h-[110px] w-full resize-y rounded-lg border border-input bg-background px-3 py-3 text-sm outline-none transition focus-visible:ring-2 focus-visible:ring-ring"
                    />
                  </div>
                </div>
              </div>
              ...
              <div className="rounded-lg border bg-muted/20 p-4 text-sm">
                <div className="flex items-center gap-2 font-semibold">
                  <CheckCircle2 className="h-4 w-4 text-[#a57b3d]" />
                  {t.nextStepTitle}
                </div>
                <p className="mt-2 text-muted-foreground">{t.nextStepDesc}</p>
