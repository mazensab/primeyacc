...
function FieldLabel({
  ...
  return (
    <div className="mb-2 flex items-center gap-2">
      ...
      {required ? (
        <span aria-hidden="true" className="text-sm font-semibold text-[#a57b3d]">
          *
        </span>
      ) : null}
    </div>
  ...
  return (
    <main dir={dir} className="w-full space-y-4 text-foreground lg:space-y-6">
      <div className="w-full space-y-4 lg:space-y-6">
        ...
        <form id="company-create-form" onSubmit={submitForm} className="grid gap-4 lg:gap-6 xl:grid-cols-[minmax(0,1fr)_340px]">
          <div className="space-y-4 lg:space-y-6">
            <Card>
              <CardHeader>
                <CardTitle icon={Building2} iconPosition="opposite">{t.basicInfo}</CardTitle>
            ...
            <Card>
              <CardHeader>
                <CardTitle icon={ShieldCheck} iconPosition="opposite">{t.legalInfo}</CardTitle>
            ...
            <Card>
              <CardHeader>
                <CardTitle icon={Mail} iconPosition="opposite">{t.contactInfo}</CardTitle>
            ...
            <Card>
              <CardHeader>
                <CardTitle icon={MapPin} iconPosition="opposite">{t.nationalAddress}</CardTitle>
            ...
            <Card>
              <CardHeader>
                <CardTitle icon={CircleAlert} iconPosition="opposite">{t.notesInfo}</CardTitle>
          ...
          <aside className="space-y-4 lg:space-y-6">
            <Card className="xl:sticky xl:top-20">
              <CardHeader>
                <CardTitle icon={CheckCircle2} iconPosition="opposite">{t.readiness}</CardTitle>
              ...
              <CardContent className="space-y-4">
                ...
                <div className="grid gap-2">
                  <Button type="submit" form="company-create-form" disabled={submitting || !isReady} className={registerBrandButtonClass}>
                    {submitting ? <Loader2 className="h-4 w-4 animate-spin" /> : <Plus className="h-4 w-4" />}
                    {submitting ? t.saving : t.submitCreate}
                  </Button>

                  <Button type="button" variant="outline" className={registerOutlineButtonClass} onClick={saveDraft}>
                    <Save className="h-4 w-4" />
                    {t.saveDraft}
                  </Button>
                  ...
                  <Button type="button" variant="outline" className={registerOutlineButtonClass} onClick={clearDraft} disabled={!draftAvailable}>
