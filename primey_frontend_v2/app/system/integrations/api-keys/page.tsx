  ...
  return (
    <Card className="overflow-hidden rounded-lg border-border/70 bg-card shadow-none transition hover:-translate-y-0.5 hover:shadow-md">
      <CardHeader className="flex flex-row items-start justify-between gap-3 space-y-0 pb-2">
        ...
        <span className="flex size-11 shrink-0 items-center justify-center rounded-full border border-border/70 bg-white/80 text-[#a57b3d] shadow-none backdrop-blur-sm">
...
function ApiKeysSkeleton() {
  return (
    <main className="space-y-4 text-foreground lg:space-y-6">
...
export default function SystemIntegrationApiKeysPage() {
  ...
  return (
    <main dir={dir} className="space-y-4 text-foreground lg:space-y-6">
      <div className="w-full space-y-6">
        <header className="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
          ...
          <div className="flex flex-wrap items-center gap-2">
                ...
                <Button className="rounded-lg bg-black text-white hover:bg-black/90" onClick={exportExcel}>
                  <FileSpreadsheet className="h-4 w-4" />
                  {t.exportExcel}
                </Button>
                <Button className="rounded-lg bg-black text-white hover:bg-black/90" onClick={() => openPrintWindow("print")}>
                  <Printer className="h-4 w-4" />
                  {t.print}
                </Button>
                {canCreateApiKey ? (
                  <Button className="rounded-lg bg-black text-white hover:bg-black/90" onClick={openCreateModal}>
      ...
      {createOpen && canCreateApiKey ? (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-background/80 px-4 py-6 backdrop-blur-sm">
          <Card className="max-h-[90vh] w-full max-w-3xl overflow-y-auto rounded-lg border bg-card shadow-2xl">
            <CardHeader className="flex flex-row items-start justify-between gap-4 space-y-0 border-b">
              <div>
                <CardTitle className="flex items-center gap-2">
                  <span className="rounded-lg border bg-muted/20 p-2 text-[#a57b3d]">
