  ...
  return (
    <WorkspaceRouteGuard workspace="system">
      <SidebarProvider defaultOpen={defaultOpen} style={{
        ...
        "--content-full-height": "calc(100vh - var(--header-height) - (var(--content-padding) * 2.2) - (var(--content-margin) * 2.2))"
      } as React.CSSProperties}>
        <AppSidebar />
        <SidebarInset>
          <SiteHeader />
          <div className="flex flex-1 flex-col">
            <div className="@container/main p-(--content-padding) xl:group-data-[theme-content-layout=centered]/layout:max-w-7xl xl:group-data-[theme-content-layout=centered]/layout:w-full xl:group-data-[theme-content-layout=centered]/layout:mx-auto">{children}</div>
          </div>
        </SidebarInset>
      </SidebarProvider>
    </WorkspaceRouteGuard>
