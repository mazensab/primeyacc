...
export function BookingFormDrawer({ open, onOpenChange }: BookingFormDrawerProps) {
    ...
    <Drawer direction="right" open={open} onOpenChange={onOpenChange}>
      ...
      <DrawerContent>
        <DrawerHeader>
          ...
          <DrawerDescription>Fill out the form to create a new room booking.</DrawerDescription>
        </DrawerHeader>
