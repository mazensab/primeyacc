  ...
  return (
    <div className="space-y-4 lg:space-y-6">
      ...
      <div className="space-y-4 lg:space-y-6">
        ...
        <div className="space-y-4 lg:space-y-6 xl:grid xl:grid-cols-2 xl:gap-6 xl:space-y-0">
        ...
        <div className="space-y-4 lg:space-y-6 xl:grid xl:grid-cols-12 xl:gap-6 xl:space-y-0">
