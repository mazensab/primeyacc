  ...
  return (
    <Card>
      ...
      <CardContent className="flex flex-col p-0 [&_[data-slot=table-container]]:flex-1">
        <Table className="min-w-[560px] table-fixed [&_td:first-child]:ps-(--card-spacing) [&_td:last-child]:pe-(--card-spacing) [&_th:first-child]:ps-(--card-spacing) [&_th:last-child]:pe-(--card-spacing)">
          <TableHeader>
            <TableRow>
