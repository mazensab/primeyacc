...
export function SocialMediaStories() {
  ...
  return (
    <>
      <div className="-mx-1.5 flex w-[calc(100%+--spacing(3))] scroll-fade-x scrollbar-none gap-4 overflow-x-auto overscroll-x-contain px-1.5 py-1.5 select-none">
        <div
        ...
        {reels.map((reel) => (
          <div key={reel.id} className="shrink-0" onClick={() => handleReelClick(reel.id)}>
            <div className="flex cursor-pointer flex-col items-center gap-2 hover:opacity-80">
              <Avatar
