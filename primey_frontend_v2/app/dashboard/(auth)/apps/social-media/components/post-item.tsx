    ...
    <Card>
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="flex flex-col gap-0.5">
            <div className="flex items-center gap-1">
              ...
              {post.verified && <BadgeCheck className="size-3.5 fill-blue-500 text-white" />}
            </div>
      ...
      <CardContent className="space-y-3">
        ...
        {post.type === "image" && post.image && (
          <div className="ring-foreground/5 overflow-hidden rounded-lg ring-1">
            <img src={post.image} alt="Post" className="aspect-video w-full object-cover" />
          </div>
        )}

        {post.type === "video" && post.videoThumbnail && (
          <div className="ring-foreground/5 relative overflow-hidden rounded-lg ring-1">
            <img
        ...
        {post.type === "text" && post.text && (
          <div className="bg-muted/60 rounded-lg p-4">
            <p className="text-[15px] leading-relaxed whitespace-pre-line">{post.text}</p>
          </div>
        )}
        ...
        <div className="flex items-center gap-2">
          <div className="flex -space-x-2">
            <Avatar className="border-card h-5 w-5 border-2">
