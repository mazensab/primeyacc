...
export function CourseModules({ data }: CourseModulesProps) {
  ...
  return (
    <Card className="lg:border-border gap-4 border-transparent lg:gap-6 max-lg:bg-transparent max-lg:ring-0">
      <CardHeader>
      ...
      <CardContent className="max-lg:bg-transparent max-lg:ring-0 max-lg:shadow-none">
