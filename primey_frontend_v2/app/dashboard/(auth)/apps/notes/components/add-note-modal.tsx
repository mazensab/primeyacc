...
export function AddNoteModal() {
  ...
  return (
    <Dialog>
      ...
      <DialogContent className="max-h-screen sm:max-w-(--breakpoint-sm) overflow-y-scroll p-0 lg:overflow-y-auto">
        {imagePreview && (
          <figure>
            <img
              src={imagePreview}
        ...
        <form className={cn("min-w-0", { "p-6": !imagePreview, "p-6 pt-0": imagePreview })}>
