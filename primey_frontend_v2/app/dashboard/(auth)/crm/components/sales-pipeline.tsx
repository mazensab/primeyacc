      ...
      <CardHeader>
        <CardTitle className="flex items-center gap-1.5">
          ...
          <Tooltip>
            ...
            <TooltipContent>Current deals in your sales pipeline.</TooltipContent>
          </Tooltip>
        </CardTitle>
      </CardHeader>
      <CardContent>
              ...
              <Tooltip key={stage.id}>
                ...
                <TooltipContent>
                  <div className="text-sm">
                    ...
                    <p className="text-muted-foreground text-xs">${stage.value.toLocaleString("en-US")}</p>
                  </div>
                </TooltipContent>
              </Tooltip>
            ))}
              ...
              <div className="flex flex-1 items-center justify-between">
                <div>
                  ...
                  <p className="text-muted-foreground text-xs">
                    {stage.count} deals · ${stage.value.toLocaleString("en-US")}
                  </p>
                </div>
