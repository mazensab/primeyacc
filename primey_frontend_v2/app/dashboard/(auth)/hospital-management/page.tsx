    ...
    <div className="space-y-4 lg:space-y-6">
      ...
      <Tabs defaultValue="overview" className="space-y-4 lg:space-y-6">
        ...
        <TabsContent value="overview" className="space-y-4 lg:space-y-6">
          <SummaryCards />
          <div className="gap-4 lg:gap-6 space-y-4 md:grid-cols-2 lg:grid lg:grid-cols-7 lg:space-y-0">
            <PatientVisitsChart />
            <PatientsByDepartmentChart />
          </div>
          <div className="gap-4 lg:gap-6 space-y-4 lg:grid lg:space-y-0 xl:grid-cols-3">
            <PlannedCalendar />
            <Notes />
            <TopTreatment />
          </div>
