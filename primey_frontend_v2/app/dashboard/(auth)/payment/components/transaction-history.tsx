    ...
    <Card className="pb-0">
      ...
      <CardContent className="flex flex-col p-0 [&_[data-slot=table-container]]:flex-1">
        <Tabs defaultValue="latest" className="gap-0!">
          <TabsList
            variant="line"
            className="h-auto w-full justify-start gap-6 rounded-none border-b p-0 ps-(--card-spacing)">
            <TabsTrigger value="latest" className="flex-none px-0 py-2.5 -mt-1 after:-bottom-px">
              Latest
            </TabsTrigger>
            <TabsTrigger value="upcoming" className="flex-none px-0 py-2.5 -mt-1 after:-bottom-px">
              Upcoming
            </TabsTrigger>
          </TabsList>
