          ...
          {["mobile", "desktop"].map((key) => {
            ...
            return (
              <button
                ...
                className="hover:bg-card/60 data-[active=true]:bg-card data-[active=true]:ring-foreground/10 flex flex-col gap-0.5 rounded-lg px-4 py-1.5 text-left transition-colors data-[active=true]:shadow-2xs data-[active=true]:ring-1"
