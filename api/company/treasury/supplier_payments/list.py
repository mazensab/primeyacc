...
def serialize_supplier_payment(payment: SupplierPayment) -> dict[str, Any]:
    ...
    return {
        ...
        "counterparty_type_display": payment.get_counterparty_type_display(),
        "counterparty_id": payment.counterparty_id,
        "counterparty_name": payment.counterparty_name,
        "counterparty_phone": payment.counterparty_phone,
        "counterparty_account_id": payment.counterparty_account_id,
        "counterparty_account_code": payment.counterparty_account.code if payment.counterparty_account_id else "",
        "counterparty_account_name": payment.counterparty_account.name if payment.counterparty_account_id else "",
        "has_counterparty_account": bool(payment.counterparty_account_id),
