...
def company_supplier_debit_note_update(
    request: Request,
    debit_note_id: int,
) -> Response:
    """
    Update a draft company supplier debit note.
    """
    try:
        ...
        return Response(
            {
                ...
                "success": False,
                "message": (
                    "Supplier debit note could not be updated."
                ),
...
company_supplier_debit_note_update.required_company_permissions = [
