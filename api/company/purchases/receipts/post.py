...
def company_purchase_receipt_post(
    request: Request,
        ...
        return Response(
            {
                ...
                "success": True,
                "message": (
                    "Purchase receipt posted successfully."
                ),
        ...
        return Response(
            {
                ...
                "success": False,
                "message": (
                    "Purchase receipt could not be posted."
                ),
...
company_purchase_receipt_post.required_company_permissions = [
