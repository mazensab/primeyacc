...
def company_sales_credit_note_issue(
    request: Request,
    credit_note_id: int,
) -> Response:
    """
    Issue a draft company-scoped credit note.
    """
    try:
...
company_sales_credit_note_issue.required_company_permissions = [
