...
export default function SystemCompaniesPage() {
  ...
  function buildExcelSection(): ExcelReportSection {
    return {
      title: t.tableTitle,
      headers: [t.company, t.code, t.owner, t.activity, t.subscription, t.city, t.status, t.createdAt],
      widths: [240, 140, 170, 170, 170, 130, 130, 160],
  ...
  function exportExcel() {
    ...
    downloadExcelReport({
      ...
      title: t.reportTitle,
      subtitle: t.subtitle,
      filename: `Mhamcloud-system-companies-overview-${new Date().toISOString().slice(0, 10)}.xls`,
  ...
  return (
    <main dir={dir} className="min-h-screen bg-transparent px-4 py-6 text-foreground sm:px-6 lg:px-8">
      <div className="w-full space-y-6">
        ...
        <div className="grid gap-4 md:grid-cols-2 xl:grid-cols-4">
          <SystemKpiCard title={t.totalCompanies} value={stats.total} description={t.fromLiveApi} href="/system/companies/list" icon={Building2} />
          <SystemKpiCard title={t.activeCompanies} value={stats.active} description={t.fromLiveApi} href="/system/companies/list" icon={CheckCircle2} />
          <SystemKpiCard title={t.inactiveCompanies} value={stats.inactive} description={t.fromLiveApi} href="/system/companies/list" icon={ShieldCheck} />
