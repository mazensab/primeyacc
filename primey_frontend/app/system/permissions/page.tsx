            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                <p className="font-semibold text-foreground">
                  {textByLocale(locale, "كتالوج صلاحيات للقراءة فقط", "Read-only permissions catalog")}
                </p>
                <p className="mt-1 text-sm leading-6 text-muted-foreground">
                  {textByLocale(
                    locale,
                    "هذه الصفحة تعرض تعريفات الصلاحيات المعتمدة فقط. إسناد الصلاحيات وإدارة المستخدمين يتمان من عقود المستخدمين الحالية، ولا توجد هنا عمليات إنشاء أو تعديل أو حذف وهمية.",
                    "This page exposes the approved permission definitions only. User access remains governed by the existing user contracts; no unsupported create, edit, delete, or assignment actions are presented here.",
                  )}
                </p>
              </div>
            </div>
