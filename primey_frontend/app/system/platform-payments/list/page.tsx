...
/* ============================================================
   📂 primey_frontend/app/system/platform-payments/list/page.tsx
   💳 PrimeyAcc — System Platform Payments List
   ------------------------------------------------------------
...
const translations = {
  ar: {
    ...
    subtitle:
      "إدارة ومراجعة إيصالات دفع المنصة في PrimeyAcc مع البحث والفلاتر والتصدير والطباعة وملف PDF.",
    refresh: "تحديث",
