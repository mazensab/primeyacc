    ...
    <DayPicker
      ...
      classNames={{
        ...
        button_previous: cn(
          ...
          "size-(--cell-size) aria-disabled:opacity-50 p-0 select-none text-primary hover:bg-accent hover:text-accent-foreground",
  ...
  return (
    <Button
      ...
      className={cn(
        ...
        modifiers.today &&
          !modifiers.selected &&
          "border border-primary/60 bg-primary/10 font-semibold text-primary ring-1 ring-primary/20 hover:bg-primary/15",
        modifiers.today &&
          modifiers.selected &&
