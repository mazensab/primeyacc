...
const content: Record<AppLang, FooterContent> = {
  ar: {
    description:
      "Mhamcloud نظام محاسبي وإداري سحابي يربط المحاسبة والمبيعات والمشتريات والعملاء والموردين والمخزون والخزينة والتقارير في بيئة عمل واحدة.",
    disclaimer:
      "يتم تحديد الوحدات والمستخدمين ونطاق التهيئة والاشتراك وفق الباقة واحتياج كل منشأة.",
    groups: {
      explore: "استكشف",
      programs: "الحلول",
      support: "الدعم",
    ...
    links: {
      benefits: "المزايا",
      features: "قدرات المنصة",
      pricing: "الباقات",
      register: "اطلب تجربة",
      annualCard: "المحاسبة والمالية",
      dentalProgram: "المبيعات والفوترة",
      checkupsProgram: "المشتريات والمخزون",
      beautyProgram: "الخزينة والمدفوعات",
      contactUs: "تواصل معنا",
      faq: "الأسئلة الشائعة",
      network: "حالات الاستخدام",
      offers: "الباقات والاشتراكات",
      facebook: "فيسبوك",
      twitter: "إكس",
      instagram: "إنستغرام",
      youtube: "يوتيوب",
  ...
  en: {
    description:
      "Mhamcloud is a cloud accounting and business management platform connecting accounting, sales, purchases, customers, suppliers, inventory, treasury, and reporting in one workspace.",
    disclaimer:
      "Modules, users, setup scope, and subscription coverage are defined according to each organization's selected plan and requirements.",
    groups: {
      explore: "Explore",
      programs: "Solutions",
      support: "Support",
    ...
    links: {
      ...
      pricing: "Pricing",
      register: "Request a Trial",
      annualCard: "Accounting & Finance",
      dentalProgram: "Sales & Invoicing",
      checkupsProgram: "Purchases & Inventory",
      beautyProgram: "Treasury & Payments",
      contactUs: "Contact Us",
      faq: "FAQ",
      network: "Use Cases",
      offers: "Plans & Subscriptions",
      facebook: "Facebook",
      twitter: "X",
      instagram: "Instagram",
      youtube: "YouTube",
